...
cd /mnt/nas/projects/pika_ros/scripts && bash start_multi_sensor.bash sensor

conda deactivate
source /mnt/nas/projects/pika_ros/install/setup.bash
cd /mnt/nas/projects/pika_ros/scripts && bash start_multi_gripper.bash gripper sensor
