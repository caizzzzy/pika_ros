...
def generate_launch_description():
    ...
    locator_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(get_package_share_directory('piper'), 'launch', 'start_double_piper.launch.py')])
    )
