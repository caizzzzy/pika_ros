...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('paramsFile', default_value=os.path.join(share_dir, 'config', 'data_params.yaml')),
    ...
    return LaunchDescription(declared_arguments+[
        ...
        Node(
            package='data_tools', 
            executable='compress_camera.py', 
            name="camera_fisheye_compress_node",
            output='log',
            parameters=[{
                'topic_namespace': "camera_fisheye",
            }],
        ),
