...
local_parameters = [{'name': 'camera_name1',            'default': 'camera1', 'description': 'camera unique name'},
                    ...
                    {'name': 'camera_name3',            'default': 'camera3', 'description': 'camera unique name'},
                    {'name': 'camera_namespace1',       'default': '', 'description': 'camera1 namespace'},
                    {'name': 'camera_namespace2',       'default': '', 'description': 'camera2 namespace'},
                    {'name': 'camera_namespace3',       'default': '', 'description': 'camera3 namespace'},
                    ...
                    {'name': 'enable_color3',           'default': 'true', 'description': 'enable color stream'},
                    ...
                    {'name': 'enable_depth3',           'default': 'true', 'description': 'enable depth stream'},
                    ...
                    {'name': 'pointcloud.enable3',      'default': 'true', 'description': 'enable pointcloud'},
                    ...
                    {'name': 'spatial_filter.enable3',  'default': 'true', 'description': 'enable_spatial_filter'},
                    ...
                    {'name': 'temporal_filter.enable3', 'default': 'true', 'description': 'enable_temporal_filter'},
