...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '0,0,0', 'description': 'color stream profile'},
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    return [
        launch_ros.actions.Node(
            ...
            # ('camera_link', [LaunchConfiguration('camera_namespace' + param_name_suffix), TextSubstitution(text='/'), LaunchConfiguration('camera_name' + param_name_suffix), TextSubstitution(text='_link')]),
            # ('camera_color_frame', [LaunchConfiguration('camera_namespace' + param_name_suffix), TextSubstitution(text='/'), LaunchConfiguration('camera_name' + param_name_suffix), TextSubstitution(text='_color_frame')]),
            # ('camera_color_optical_frame', [LaunchConfiguration('camera_namespace' + param_name_suffix), TextSubstitution(text='/'), LaunchConfiguration('camera_name' + param_name_suffix), TextSubstitution(text='_color_optical_frame')]),
            # ('camera_depth_frame', [LaunchConfiguration('camera_namespace' + param_name_suffix), TextSubstitution(text='/'), LaunchConfiguration('camera_name' + param_name_suffix), TextSubstitution(text='_depth_frame')]),
            # ('camera_depth_optical_frame', [LaunchConfiguration('camera_namespace' + param_name_suffix), TextSubstitution(text='/'), LaunchConfiguration('camera_name' + param_name_suffix), TextSubstitution(text='_depth_optical_frame')]),
            ]
        )
    ]
