...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('paramsFile', default_value=os.path.join(share_dir, 'config', 'lift_data_params.yaml')),
    ...
    return LaunchDescription(declared_arguments+[
        ...
        Node(
            ...
            name="camera_down_compress_node",
            output='log',
            parameters=[{
                'topic_namespace': "camera_down",
            }],
        ),
        Node(
            package='data_tools', 
