...
#ifndef DATA_MSGS__SRV__DETAIL__CAPTURE_SERVICE__FUNCTIONS_H_
#define DATA_MSGS__SRV__DETAIL__CAPTURE_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/CaptureService message.
/**
...
/// Finalize srv/CaptureService message.
/**
...
/// Create srv/CaptureService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * data_msgs__srv__CaptureService_Request__init().
...
/// Destroy srv/CaptureService message.
/**
 * It calls
 * data_msgs__srv__CaptureService_Request__fini()
...
/// Check for srv/CaptureService message equality.
/**
...
/// Copy a srv/CaptureService message.
/**
...
/// Initialize array of srv/CaptureService messages.
/**
...
/// Finalize array of srv/CaptureService messages.
/**
 * It calls
 * data_msgs__srv__CaptureService_Request__fini()
...
/// Create array of srv/CaptureService messages.
/**
 * It allocates the memory for the array and calls
 * data_msgs__srv__CaptureService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CaptureService messages.
/**
 * It calls
 * data_msgs__srv__CaptureService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CaptureService message array equality.
/**
...
/// Copy an array of srv/CaptureService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * data_msgs__srv__CaptureService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_data_msgs
...
/**
 * It calls
 * data_msgs__srv__CaptureService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_data_msgs
...
/**
 * It allocates the memory for the array and calls
 * data_msgs__srv__CaptureService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_data_msgs
...
/**
 * It calls
 * data_msgs__srv__CaptureService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DATA_MSGS__SRV__DETAIL__CAPTURE_SERVICE__FUNCTIONS_H_
