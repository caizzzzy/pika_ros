    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'data_msgs.msg.LocalizationStatus')
            logger.debug(
...
class LocalizationStatus(metaclass=Metaclass_LocalizationStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.accurate = kwargs.get('accurate', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.accurate != other.accurate:
            return False
        return True
    ...
    def accurate(self, value):
        if __debug__:
            assert \
                ...
                "The 'accurate' field must be of type 'bool'"
