...
#include "data_msgs/msg/detail/localization_status__rosidl_typesupport_fastrtps_c.h"
...
using _LocalizationStatus__ros_msg_type = data_msgs__msg__LocalizationStatus;
...
size_t get_serialized_size_data_msgs__msg__LocalizationStatus(
  const void * untyped_ros_message,
...
static uint32_t _LocalizationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_data_msgs__msg__LocalizationStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_data_msgs
size_t max_serialized_size_data_msgs__msg__LocalizationStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs__msg__LocalizationStatus;
    is_plain =
      (
...
static size_t _LocalizationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_data_msgs__msg__LocalizationStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, msg, LocalizationStatus)() {
