...
#include "data_msgs/msg/detail/gripper__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_data_msgs
...
using _Gripper__ros_msg_type = data_msgs__msg__Gripper;
...
size_t get_serialized_size_data_msgs__msg__Gripper(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper__ros_msg_type * ros_message = static_cast<const _Gripper__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Gripper__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_data_msgs__msg__Gripper(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_data_msgs
size_t max_serialized_size_data_msgs__msg__Gripper(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs__msg__Gripper;
    is_plain =
      (
...
static size_t _Gripper__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_data_msgs__msg__Gripper(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, msg, Gripper)() {
