...
#include "data_msgs/srv/detail/capture_service__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // dataset_dir, instructions
#include "rosidl_runtime_c/string_functions.h"  // dataset_dir, instructions

// forward declare type support functions


using _CaptureService_Request__ros_msg_type = data_msgs__srv__CaptureService_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: dataset_dir
  {
    const rosidl_runtime_c__String * str = &ros_message->dataset_dir;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: dataset_dir
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->dataset_dir.data) {
      rosidl_runtime_c__String__init(&ros_message->dataset_dir);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->dataset_dir,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'dataset_dir'\n");
      return false;
    }
  }
...
size_t get_serialized_size_data_msgs__srv__CaptureService_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->dataset_dir.size + 1);
  // field.name instructions
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
...
static uint32_t _CaptureService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_data_msgs__srv__CaptureService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_data_msgs
size_t max_serialized_size_data_msgs__srv__CaptureService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs__srv__CaptureService_Request;
    is_plain =
      (
      offsetof(DataType, instructions) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CaptureService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_data_msgs__srv__CaptureService_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService_Request)() {
...
using _CaptureService_Response__ros_msg_type = data_msgs__srv__CaptureService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_data_msgs
size_t get_serialized_size_data_msgs__srv__CaptureService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CaptureService_Response__ros_msg_type * ros_message = static_cast<const _CaptureService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_data_msgs__srv__CaptureService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_data_msgs
size_t max_serialized_size_data_msgs__srv__CaptureService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = data_msgs__srv__CaptureService_Response;
    is_plain =
      (
...
static size_t _CaptureService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_data_msgs__srv__CaptureService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService_Response)() {
...
// already included above
// #include "data_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "data_msgs/srv/capture_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService)() {
