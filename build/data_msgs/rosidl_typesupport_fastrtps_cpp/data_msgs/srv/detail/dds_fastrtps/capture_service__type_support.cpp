...
#include "data_msgs/srv/detail/capture_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs::srv::CaptureService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_msgs::srv::CaptureService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<data_msgs::srv::CaptureService_Request *>(
    untyped_ros_message);
...
{
  return &data_msgs::srv::typesupport_fastrtps_cpp::_CaptureService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = data_msgs::srv::CaptureService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_msgs::srv::CaptureService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<data_msgs::srv::CaptureService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &data_msgs::srv::typesupport_fastrtps_cpp::_CaptureService_Response__handle;
}
...
{
  return &data_msgs::srv::typesupport_fastrtps_cpp::_CaptureService__handle;
}
