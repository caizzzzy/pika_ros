...
#include "data_msgs/msg/detail/localization_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const data_msgs::msg::LocalizationStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accurate
  cdr << (ros_message.accurate ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  data_msgs::msg::LocalizationStatus & ros_message)
{
  // Member: accurate
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.accurate = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: accurate
  {
    size_t item_size = sizeof(ros_message.accurate);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs::msg::LocalizationStatus;
    is_plain =
      (
      offsetof(DataType, accurate) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const data_msgs::msg::LocalizationStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<data_msgs::msg::LocalizationStatus *>(
    untyped_ros_message);
...
{
  return &data_msgs::msg::typesupport_fastrtps_cpp::_LocalizationStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, data_msgs, msg, LocalizationStatus)() {
  return &data_msgs::msg::typesupport_fastrtps_cpp::_LocalizationStatus__handle;
}
