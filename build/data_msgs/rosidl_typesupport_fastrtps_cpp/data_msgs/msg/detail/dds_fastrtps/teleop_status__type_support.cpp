...
#include "data_msgs/msg/detail/teleop_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const data_msgs::msg::TeleopStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  data_msgs::msg::TeleopStatus & ros_message)
{
  // Member: topics
  {
    cdr >> ros_message.topics;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_data_msgs
max_serialized_size_TeleopStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_msgs::msg::TeleopStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_msgs::msg::TeleopStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<data_msgs::msg::TeleopStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TeleopStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const data_msgs::msg::TeleopStatus *>(
...
static size_t _TeleopStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TeleopStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TeleopStatus__callbacks = {
  "data_msgs::msg",
  "TeleopStatus",
...
static rosidl_message_type_support_t _TeleopStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TeleopStatus__callbacks,
...
{
  return &data_msgs::msg::typesupport_fastrtps_cpp::_TeleopStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, data_msgs, msg, TeleopStatus)() {
  return &data_msgs::msg::typesupport_fastrtps_cpp::_TeleopStatus__handle;
}
