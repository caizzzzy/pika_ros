...
static const _CaptureStatus_type_support_symbol_names_t _CaptureStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, msg, CaptureStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, data_msgs, msg, CaptureStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, data_msgs, msg, CaptureStatus)() {
  return &::data_msgs::msg::rosidl_typesupport_c::CaptureStatus_message_type_support_handle;
}
