...
static const _CaptureService_Request_type_support_symbol_names_t _CaptureService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, data_msgs, srv, CaptureService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, data_msgs, srv, CaptureService_Request)() {
  return &::data_msgs::srv::rosidl_typesupport_c::CaptureService_Request_message_type_support_handle;
}
...
static const _CaptureService_Response_type_support_symbol_names_t _CaptureService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, data_msgs, srv, CaptureService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, data_msgs, srv, CaptureService_Response)() {
  return &::data_msgs::srv::rosidl_typesupport_c::CaptureService_Response_message_type_support_handle;
}
...
static const _CaptureService_type_support_symbol_names_t _CaptureService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, data_msgs, srv, CaptureService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, data_msgs, srv, CaptureService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, data_msgs, srv, CaptureService)() {
  return &::data_msgs::srv::rosidl_typesupport_c::CaptureService_service_type_support_handle;
}
